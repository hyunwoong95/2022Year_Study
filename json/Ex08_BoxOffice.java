...
public class Ex08_BoxOffice {
	public static void main(String[] args) {
	    ...
	    try {
			...
			InputStreamReader isr = new InputStreamReader(url.openStream()); //Json에서는 url을 읽을수없기때문에 
			...
			for(JsonElement e:jsonArray) {
				...
				System.out.println(obj.get("rank").getAsInt());
				System.out.println(obj.get("movieNm").getAsString());
