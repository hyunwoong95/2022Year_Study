...
class Up{
	...
	public void show() {
		System.out.println("나는 부모메서드 이다.");
	}
	@Override
...
class Down extends Up{
	...
	public void show() {
		System.out.println("나는 자식메서드 이다.");
	}
	@Override
	public String toString() {
...
public class UpDownEx {
	public static void main(String[] args) {
		...
		//Down down2 = new Up(); // 자식타입에 부모의 객체를 대입하면 에러!!
		...
		Down down2 = (Down)up2; //up2가 Up타입이지만 실제 자식의 타입을 가르키고 있기 때문에 예외가 발생하지 않는다.
		down2.show();			// DownCasting ==> 반드시 instanceof연산자를 사용하여 대입가능 여부를 판단하여 대입해줘야한다.
