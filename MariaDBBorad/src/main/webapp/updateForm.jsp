...
<body>
	...
	<table>
		<tr>
			<td class="title" colspan="4">게시판 수정하기</td>
		</tr>
		<tr>
			<td>이름</td>
		...
		<tr>
			...
			<td colspan="3" style="text-align: left"> 
				<input type="text" name="subject" id="subject" required="required" size="90" value="${vo.subject }"/>
			</td>
		</tr>
		<tr>
			<td valign="top">내용</td>
			<td colspan="3"  style="text-align: left">
				<textarea rows="10" cols="100" name="content" id="content" required="required">${vo.content }</textarea>
			</td>
		</tr>
		<tr>
